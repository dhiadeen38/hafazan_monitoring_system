...
<body>
  ...
  $sql="SELECT ic_no,stud_name,stud_id,halaqah_id,page_memorized,(
      CASE
  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
        ...
        <li><a style="background: yellow; color:#522184" href="parentrecord.php"><i class="fa fa-bar-chart"></i> Performance Record</a></li>
    ...
    <div class="container-fluid">
      <div class="card row">
        <nav class="card-body" aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="parentrecord.php">Performance Record</a></li>
