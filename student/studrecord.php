...
<body>
  ...
  $sql="SELECT programme.curr_syllabus, student.page_memorized, student.halaqah_id, student.batch_id
  FROM programme
  INNER JOIN student
  ON programme.programme_id=student.programme_id
  WHERE student.stud_id='$id' ";
    ...
    <div id="page-content-header" class="sticky-top">
      ...
      <div id="page-content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              <h3>Your Hafazan Performance</h3>
              <div class="row">
                <?php
