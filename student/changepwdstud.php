  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
        ...
        <li><a style="background: yellow; color:#522184" href="changepwdstud.php"><i class="fa fa-refresh"></i> Change password</a></li>
        ...
        <div class="card row">
          <div class="card-body col-lg-12">
            ...
            if (ISSET($_SESSION['message'])&& $_SESSION['message'] !=''){
             ...
             ?>
            <form action="changingpwdstud.php" method="post">
